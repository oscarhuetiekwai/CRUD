		...
		init: function(){
            ...
            function openKCFinder(field_name, url, type, win) {
                ...
                tinyMCE.activeEditor.windowManager.open({
                    file: 'http://203.223.144.218/staging/oscar/alphacrossing/system/assets/js/file-manager/browse.php?opener=tinymce&type=' + type,
                    title: 'KCFinder',
                    width: 700,
                    height: 500,
                    resizable: "yes",
            ...
            $('textarea#wysiwg_full').tinymce({
                ...
                script_url 							: 'http://203.223.144.218/staging/oscar/alphacrossing/system/assets/js/lib/tiny_mce/tiny_mce.js',
                // General options
                theme 								: "advanced",
                ...
                file_browser_callback: function openKCFinder(field_name, url, type, win) {
                    tinyMCE.activeEditor.windowManager.open({
                        file: 'http://203.223.144.218/staging/oscar/alphacrossing/system/assets/js/file-manager/browse.php?opener=tinymce&type=' + type + '&dir=image/themeforest_assets',
                        title: 'KCFinder',
                        width: 700,
                        height: 500,
                        resizable: "yes",
